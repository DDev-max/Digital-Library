...
export function FavoriteSVG({ added, className }: FavoriteSVGProps) {
  return (
    <svg aria-hidden className={`${added ? 'svg--added' : ''} ${className}`} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' role='img'>
